  ...
  return (
    <div className="toolbar">
      <div className="toolbar__row">
        <div className="toolbar__group">
          ...
          <div className="toolbar__select-wrap">
            <svg className="toolbar__select-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <svg className="toolbar__select-chevron" width="11" height="11" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <div className="toolbar__group">
          ...
          <button type="button" className="toolbar__export" onClick={onExport} disabled={exporting}>
      ...
      <div className="toolbar__editrow">
        <span className="toolbar__editlabel">Sumber Data: {activeTab} (Google Sheets)</span>
        <div className="toolbar__editactions">
          <button type="button" className="toolbar__iconbtn" onClick={handleCopy} title="Salin link">
            {copied ? (
          ...
          <a className="toolbar__iconbtn toolbar__iconbtn--primary" href={link} target="_blank" rel="noopener noreferrer">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              <path d="M12 5H6a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            Buka di Sheets
          </a>
        </div>
